...
public class Checkin {
	...
	private Long checkinPrice;// 入住价格
	...
	private Long reserveOrderId;// 预定订单id，可为空
	...
	public Long getCheckinPrice() {
		return checkinPrice;
	}

	public void setCheckinPrice(Long checkinPrice) {
