...
<div class="easyui-layout" data-options="fit:true">
	...
	<div id="wu-toolbar">
		...
		<div class="wu-toolbar-search">
			<label>房间类型名称:</label><input id="search-name" class="wu-text"
				style="width: 100px"> <label>状态:</label> <select
				id="search-status" class="easyui-combobox" panelHeight="auto"
				style="width: 120px">
	...
	<form id="add-form" method="post">
		<table>
			<tr>
				...
				<td valign="middle"><img id="preview-photo"
					style="float: left;"
					src="/HotelSSM/resources/admin/easyui/images/user_photo.jpg"
					width="100px"> <a style="float: left; margin-top: 40px;"
			...
			<tr>
				...
				<td><input type="text" id="add-photo" name="photo"
					value="/HotelSSM/resources/admin/easyui/images/user_photo.jpg"
					readonly="readonly" class="wu-text " /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea id="add-remark" name="remark" rows="6"
...
<div id="edit-dialog" class="easyui-dialog"
	...
	<form id="edit-form" method="post">
		...
		<table>
			<tr>
				<td width="60" align="right">图片预览:</td>
				<td valign="middle"><img id="edit-preview-photo"
					style="float: left;"
					src="/HotelSSM/resources/admin/easyui/images/user_photo.jpg"
					width="100px"> <a style="float: left; margin-top: 40px;"
					href="javascript:void(0)" class="easyui-linkbutton"
			...
			<tr>
				<td align="right">可住人数:</td>
				<td><input type="text" id="edit-liveNum" name="liveNum"
					class="wu-text easyui-validatebox"
					data-options="required:true, missingMessage:'请填写房间类型可住人数'" /></td>
			</tr>
			<tr>
				<td align="right">床位数:</td>
				<td><input type="text" id="edit-bedNum" name="bedNum"
					class="wu-text easyui-validatebox"
					data-options="required:true, missingMessage:'请填写房间类型床位数'" /></td>
			</tr>
			<tr>
				<td align="right">房间数:</td>
				<td><input type="text" id="edit-roomNum" name="roomNum"
					class="wu-text easyui-validatebox"
					data-options="required:true, missingMessage:'请填写房间类型房间数'" /></td>
			</tr>
			<tr>
				<td align="right">状态:</td>
				<td><select id="edit-status" name="status"
					class="easyui-combobox" panelHeight="auto" style="width: 268px">
						<option value="0">房型已满</option>
						<option value="1">可预订可入住</option>
				</select></td>
			...
			<tr>
				<td align="right">备注:</td>
				<td><textarea id="edit-remark" name="remark" rows="6"
						class="wu-textarea" style="width: 260px"></textarea></td>
			</tr>
		</table>
	</form>
