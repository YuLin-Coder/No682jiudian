...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>管理员名称:</label><input id="search-name" class="wu-text" style="width:100px">
            <label>所属角色:</label>
            ...
            <label>是否冻结:</label>
            <select id="search-isdel" class="easyui-combobox" panelHeight="auto" style="width:120px">
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td width="60" align="right">管理员名称:</td>
...
<script type="text/javascript">
	...
	*/
	function remove(){
				...
				if(item == null || item.length == 0){
					$.messager.alert('信息提示','请选择要冻结的数据！','info');
					return;
				}
				$.messager.confirm('信息提示','确定要冻结该记录？', function(result){
                    if(result){
				var ids = '';
	...
	*/
	...
	$("#search-btn").click(function(){
        ...
        var isdel = $("#search-isdel").combobox('getValue')
