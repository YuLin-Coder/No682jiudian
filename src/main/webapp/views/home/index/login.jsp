...
<html lang="en">
 ...
 <body style="background: url('../resources/home/images/login2.jpg') no-repeat; background-size: 100%;">

       <header>
	          <div style="margin-top: 40px;">
							<a href="index.html"><img src="../resources/home/images/logo-3.png" alt="大酒店" style="width: 270px"></a> <span>会员登录</span>
			  </div>

	   </header>
       <section >
	        <div class="left">
			    <img src="../resources/home/images/login2.jpg" alt="" style="width: 600px;height: 302px;opacity: 0.8;">
			</div>
			<div class="login">
				 ...
				 <div id="normal" >
						 <ul id="nor_log">
							<li class="name" style="margin-top:25px;">
							   <input id="name" name="uname"type="text" placeholder="请输入用户名" maxlength="15">
							   <span class="icon"></span>
							</li>
							<li class="pwd" style="margin-top:25px;">
							   <input id="password" name="upwd" type="password" placeholder="密码" maxlength="15">
							   <span class="icon"></span>
							</li>
						 </ul>
						 <!--<div class="codes">-->
			...
			<div class="reg">
			   <a href="reg"  style="color: red;">立即注册 &gt;&gt;</a>
			</div>
	   </section>
