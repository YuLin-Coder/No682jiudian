...
<%--                <th>取消订单</th>--%>
            ...
            <tbody>
               <c:forEach items="${ReserveOrderList }" var="bookOrder">
               <tr>
...
<%--                           test="${bookOrder.status !=0 }">--%>
<%--                       <input type="button" class="disable" value="不可取消"--%>
<%--                              style="color: red;">--%>
<%--                   </c:if> <c:if test="${bookOrder.status == 0 }">--%>
<%--                       <input type="button" id="cancle"  name="${bookOrder.id}">可以取消</input>--%>
<%--                   </c:if></td>--%>
        ...
        <div class="info" >
          ...
          <table style="border:0px;cellspacing:0px;">
            <tbody>
			   ...
			   <tr>
					<td style="border:0px;">身份证号：</td><td style="float:left;width:400px;max-width: 820px;border:0px;"><input class="form-control" type="text" value="${account.idCard}" name="idCard" id="idCard"/></td>
                    <br><td><span id="cards" style="color:red"></span></td>
               </tr>
			   <tr>
					<td style="border:0px;">手机号码：</td><td style="float:left;width:400px;max-width: 820px;border:0px;"><input class="form-control" type="text" value="${account.mobile}" name="mobile" id="uphone" /></td>
                   <br><td><span id="ga" style="color:red"></span></td>
               </tr>
			   <tr>
