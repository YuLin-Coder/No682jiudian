...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2019, yuh Ltd." />
<title>后台管理主页</title>
...
<%--</div> --%>
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
    	<div class="wu-header-left"><h1>琉璃汀酒店后台管理系统</h1>
        </div>
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="0条未读消息">${role.name}:${admin.username}</strong>，欢迎您！</p>
            <p><a href="../home/index2" target="_blank">酒店首页</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
